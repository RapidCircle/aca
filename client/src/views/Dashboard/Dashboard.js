...
import { selectMe } from '../../actions/auth.js';
import { TestComponent } from '../../containers/TestComponent.js';

import { CustomTooltips } from '@coreui/coreui-plugin-chartjs-custom-tooltips';
import { getStyle, hexToRgba } from '@coreui/coreui/dist/js/coreui-utilities'

import createDebugger from 'debug';
const debug = createDebugger('dashboard');
...
class Dashboard extends Component {
  ...
  render() {
    const { selectMe } = this.props;
    debug('what is', selectMe);
    return (
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="6" lg="3">
            <TestComponent value={selectMe} />
          </Col>
